...
namespace Calculator
{
    ...
    public class Calculator
    {
        ...
        [DisplayName("Total Carbon Footprint:")]
        public double CarbonFootprint
        {
            get
            {
                // Carbon footprint per mile for each transportation mode
                var carbonFootprintPerMile = new Dictionary<TransportModes, double>
                {
                    { TransportModes.petrol, 0.22 },
                    { TransportModes.deisel, 0.18 },
                    { TransportModes.hybrid, 0.09 },
                    { TransportModes.electric, 0.02 },
                    { TransportModes.motorbike, 0.15 },
                    { TransportModes.electricbike, 0.01 },
                };
                ...
                // Calculate total carbon footprint based on chosen transportation mode
                totalCarbonFootprint = carbonFootprintPerMile.TryGetValue(transportMode, out double carbonFactor)
                    ? carbonFactor * distanceInMiles * numDays
                    : 0;
